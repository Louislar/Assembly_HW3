...
del hw3_basic.lst	REM hw3_basic可以替換成.asm檔的檔名
del hw3_basic.obj
del hw3_basic.ilk
del hw3_basic.pdb
del hw3.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hw3_basic.exe hw3_basic.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
