...
del hw3_bonus.lst	REM hw3_bonus可以替換成.asm檔的檔名
del hw3_bonus.obj
del hw3_bonus.ilk
del hw3_bonus.pdb
del hw3.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console /entry:start /out:hw3_bonus.exe hw3_bonus.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
